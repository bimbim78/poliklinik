...
<?php
    if (isset($_POST['simpan'])) {
        if (isset($_POST['id'])) {
            ...
            $tambah = mysqli_query($mysqli, "INSERT INTO obat(nama_obat,kemasan,harga,status) 
                                            VALUES ( 
                                                '" . $_POST['nama_obat'] . "',
                                                '" . $_POST['kemasan'] . "',
                                                '" . $_POST['harga'] . "',
