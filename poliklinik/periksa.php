...
<link href="css/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
   ...
   <!-- Custom navbar for this template -->
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="index.php" data-bs-toggle="dropdown" aria-expanded="false">Data Master</a>
...
<main class="container">
    <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
       ...
       <div class="row mb-3">
       <div class="col-md-4">
            <label for="inputPasien" class="mt-1 form-label fw-bold">Nama Pasien</label>
            <select class="form-control" name="id_pasien">
                <?php
                $selected = '';
                $id_pasien = mysqli_query($mysqli, "SELECT * FROM pasien");
                while ($data = mysqli_fetch_array($id_pasien)) {
        ...
        <div class="row mb-3">
        <div class="col-md-4">
              <label for="inputDokter" class="mt-1 form-label fw-bold">Nama Dokter</label>
              <select class="form-control" name="id_pasien">
                  <?php
                  $selected = '';
                  $id_dokter = mysqli_query($mysqli, "SELECT * FROM dokter");
                  while ($data = mysqli_fetch_array($id_dokter)) {
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="inputTanggal" class="mt-1 form-label fw-bold">Tanggal dan Waktu Periksa</label>
                <input type="datetime-local" class="form-control" name="tgl_periksa" id="inputTanggal" value="<?php echo $tgl_periksa ?>">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="inputIsi" class="mt-1 form-label fw-bold">Catatan</label>
                <input type="text" class="form-control" name="catatan" id="inputCatatan" placeholder="Catatan" value="<?php echo $catatan ?>">
            </div>
        <div class="row mb-3">
            <div class="col-md-6">
                <button type="submit" class="mt-4 btn btn-primary rounded-pill px-3" name="simpan">Simpan</button>
            </div>
        </div>
    </form>
</main>
...
<table class="table table-hover">
    ...
    <!-- Kode Script untuk menampilkan semua isi dari tabel urut
        berdasarkan status dan tanggal awal-->
    <?php
    ...
    if (isset($_GET['aksi'])) {
        ...
        } else if ($_GET['aksi'] == 'ubah_catatan') {
    ...
    <!-- Bundle Script for this template -->
