...
<main class="form-signin w-100 m-auto">
  <form>
    ...
    <div class="form-floating">
      <input type="password" class="form-control" id="floatingConfirmPassword" placeholder="ConfimPassword">
      <label for="floatingConfirmPassword">Confirm Your Password</label>
    </div>
    <button class="btn btn-primary w-100 py-2" type="submit">Register</button>
    <p class="mt-2 login-link w-100 py-2">Already a member? <a href="login-user.php">Login here</a></p>
    <p class="w-100 py-2 text-body-secondary">&copy; 2024</p>
  </form>
</main>
